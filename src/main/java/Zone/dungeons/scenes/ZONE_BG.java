...
public class ZONE_BG extends AbstractScene {
    ...
    public ZONE_BG() {
        super("zoneResources/images/scene/atlas.atlas");
        this.bg = this.atlas.findRegion("mod/bg_bt_g");
    ...
    public void nextRoom(AbstractRoom room) {
        super.nextRoom(room);
        this.randomizeScene();
        if (room instanceof MonsterRoomBoss) { CardCrawlGame.music.silenceBGM(); }
        /*
        else if (room instanceof ShopRoom) { this.bg = this.atlas.findRegion("mod/shop"); }
        else {
